...
//? says: this program runs a bot (client), so lets use the discord.client class
...
client.on('message', async msg => { //'async' was added to support the fetch/await line. Not sure how the => structure works
 if (msg.content === 'ping') { //if any user sends a message that is exactly this string
 	msg.reply('Feeling upgraded'); //bot responds with this string
	...
	console.log(allMessages); //takes all the fetched messages including metadata and dumps them into the console as an array
 	}
 });
